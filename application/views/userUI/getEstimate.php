                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="file-upload">
                                                ...
                                                <div class="image-upload-wrap">
                                                    <input class="file-upload-input" name="homeplan" id="homeplan" type='file' onchange="readURL(this);" accept="image/*" />
                                                    <div class="drag-text">
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                ...
                                                <div class="form-group row pt-4 pb-4">
                                                    ...
                                                    <div class="quantity-block">
                                                        ...
                                                        <input class="quantity-num quantity-num-1" type="number" value="0" readonly />
                                            ...
                                            <div class="col-6">
                                                ...
                                                <div class="p-2 rounded checkbox-form">
                                                    <div class="form-check"> <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault-1"> <label class=" newsletter form-check-label" for="flexCheckDefault-1"> Wardrobe </label> </div>
                                                </div>
                                                <div class="p-2 rounded checkbox-form">
                                                    <div class="form-check"> <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault-2"> <label class=" prospect form-check-label" for="flexCheckDefault-2">
                                                            Bed </label> </div>
                                                </div>
                                                <div class="p-2 rounded checkbox-form">
                                                    <div class="form-check"> <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault-3"> <label class=" event form-check-label" for="flexCheckDefault-3">
                                                            Study Unit </label> </div>
                                                </div>
                                                <div class="p-2 rounded checkbox-form">
                                                    <div class="form-check"> <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault-4"> <label class=" customers form-check-label" for="flexCheckDefault-4"> Dressing Unit </label> </div>
                                                </div>
                                                <div class="p-2 rounded checkbox-form">
                                                    <div class="form-check"> <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault-4"> <label class=" customers form-check-label" for="flexCheckDefault-4"> Side table </label> </div>
                                                </div>
                                                <div class="p-2 rounded checkbox-form">
                                                    <div class="form-check"> <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault-4"> <label class=" customers form-check-label" for="flexCheckDefault-4"> Sofa </label> </div>
                                                </div>
                                                <div class="p-2 rounded checkbox-form">
                                                    <div class="form-check"> <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault-4"> <label class=" customers form-check-label" for="flexCheckDefault-4"> Dining Table </label> </div>
                                                </div>
                                                <div class="p-2 rounded checkbox-form">
                                                    <div class="form-check"> <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault-4"> <label class=" customers form-check-label" for="flexCheckDefault-4"> Chair </label> </div>
                                                </div>
                                                <div class="p-2 rounded checkbox-form">
                                                    <div class="form-check"> <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault-4"> <label class=" customers form-check-label" for="flexCheckDefault-4"> Customers </label> </div>
                                                </div>
                                                <div class="p-2 rounded checkbox-form">
                                                    <div class="form-check"> <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault-4"> <label class=" customers form-check-label" for="flexCheckDefault-4"> Center table </label> </div>
                                                </div>
                                                <div class="p-2 rounded checkbox-form">
                                                    <div class="form-check"> <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault-4"> <label class=" customers form-check-label" for="flexCheckDefault-4"> TV Unit </label> </div>
                                                </div>
                                                <div class="p-2 rounded checkbox-form">
                                                    <div class="form-check"> <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault-4"> <label class=" customers form-check-label" for="flexCheckDefault-4"> Crockery Unit </label> </div>
                                                </div>
                                                <div class="p-2 rounded checkbox-form">
                                                    <div class="form-check"> <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault-4"> <label class=" customers form-check-label" for="flexCheckDefault-4"> Bar Unit </label> </div>
                                                </div>
                                                <div class="p-2 rounded checkbox-form">
                                                    <div class="form-check"> <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault-4"> <label class=" customers form-check-label" for="flexCheckDefault-4"> Shoe Unit </label> </div>
                                                </div>
                                                <div class="p-2 rounded checkbox-form">
                                                    <div class="form-check"> <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault-4"> <label class=" customers form-check-label" for="flexCheckDefault-4"> Basin Unit / Mirror </label>
                                                    </div>
                                                </div>
                                                <div class="p-2 rounded checkbox-form add-list align-items-center">
                                                    <div class="text-white"> <i class="icofont-plus"></i> <span class=" ml-2">Create your own furniture</span> </div>
                                                </div>
                                            </div>
                                        </div>

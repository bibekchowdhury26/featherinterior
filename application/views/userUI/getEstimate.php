                            ...
                            <form method="post" action="<?php echo site_url('User/get_estimate_request') ?>"
                                ...
                                <fieldset>
                                    ...
                                    <div class="inputs">
                                        <div class="form-group row justify-content-center">
                                            <label class="mr-4" for="name">Full Name</label>
                                            <input type="text" class="form-control col-12 col-sm-12 col-md-10 col-lg-8"
                                                name="name" id="name" placeholder="Full Name">
                                        </div>
                                        <div class="form-group row justify-content-center">
                                            <label class="mr-4" for="phno">Phone No.</label>
                                            <input type="text" class="form-control col-12 col-sm-12 col-md-10 col-lg-8"
                                                name="phno" id="phno" placeholder="+91 XXXX XXXXXX">
                                        </div>
                                        <div class="form-group row justify-content-center">
                                            <label class="mr-4" for="email">Email ID</label>
                                            <input type="text" class="form-control col-12 col-sm-12 col-md-10 col-lg-8"
                                ...
                                <fieldset>
                                    <div class="finish row justify-content-center">
                                        <h2 class="text text-center col-12">
                                            <strong>Thank You</strong>
                                        </h2>
                                        <div style="font-size:100px;" class="col-12 text-success text-center">
                                            <i class="icofont-check-circled"></i>
                                        </div>
                                        <h4 class="message text-center col-12 col-sm-12 col-md-10 col-lg-8">
                                            We have successfully received your details. You'll be contacted through your
                                            provided details 24 hrs from our executive
                                        </h4>
                                    </div>
